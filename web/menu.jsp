        ...
        <form name="formu" action="Menu" method="post"><input type="hidden" name="opc" id="opc" value="1"></form>
            <div class="contenido text-center">
                ...
                <table>
                    ...
                    <tr>
                        <td><img onclick="opcion('2')" class="btn" src="images/menu/nuevoArte.png" title="Agregar nuevo arte" width="150" height="150"/></td>
                        <td><img onclick="opcion('3')" class="btn" src="images/menu/arteFav.png" title="Ver tu arte favorito" width="150" height="150"/></td>
                        <td><img onclick="opcion('4')" class="btn" src="images/menu/obras.png" title="Ver las obras de arte que has subido a Lienzo Urbano" width="150" height="150"/><a onclick="opcion('4')"></td>
                    </tr>
                </table>
            </div>
        <%}%>
